...
<div class="col-xl-4">
    ...
    <a href="customerdetails.php?CompanyId=<?php echo $CompanyId; ?>&Date=<?php echo date("Y-m-d") ;?>">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table table-bordered table-checkable dataTable no-footer dtr-inline">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $TotalVehiclesOutToday; ?></td>
                                            <td><span
                                                    class="label label-lg font-weight-bold label-light-primary label-inline">
                                                    <?php echo $TotalVehiclesOutTodayWeight . " " . "ٹن"; ?>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table table-bordered table-checkable dataTable no-footer dtr-inline">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $TotalVehiclesOutThisMonth; ?></td>
                                            <td><span
                                                    class="label label-lg font-weight-bold label-light-primary label-inline">
                                                    <?php echo $TotalVehiclesOutThisMonthWeight . " " . "ٹن"; ?>
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
