...
function DisplayCompaniesInDashBoard()
{
    ...
    $sql = "SELECT ct.customertype , PartyName , sum(Amount) 'Balance' ,c.Id FROM companies c Join accounts a on c.accountid = a.accountid
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            mysqli_stmt_bind_result($stmt, $CustomerType, $Companyname, $Balance, $CompanyId);
...
<div class="col-xl-4">
    ...
    <a href="customerdetails.php?CompanyId=<?php echo $CompanyId; ?>">
        <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block menu-title"><?php echo number_format($Balance) ?></span>
