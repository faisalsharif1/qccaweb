...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="dashboard.php" class="brand-logo">
            <img alt="Logo" src="assets/media/logos/logo-default-inverse.png" />
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/dashboard.php') {
                    ...
                    <a href="dashboard.php" class="menu-link">
                        ...
                        <span class="menu-text menu-title" > ڈیش بورڈ </span>
                    </a>
                </li>

                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/companies.php') {
                                            echo "menu-item-active";
                                        } ?>" aria-haspopup="true">
                    <a href="companies.php" class="menu-link">
                        ...
                        <span class="menu-text menu-title"> کمپنیز </span>
                    </a>
                </li>
                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/customers.php') {
                                            echo "menu-item-active";
                                        } ?>" aria-haspopup="true">
                    <a href="customers.php" class="menu-link">
                        ...
                        <span class="menu-text menu-title" >خریدار۔کسٹمرز</span>
                    </a>
                </li>

                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/entries.php') {
                                            echo "menu-item-active";
                                        } ?>" aria-haspopup="true">
                    <a href="entries.php" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text menu-title" > انٹری اپروول </span>
                    </a>
                </li>

                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/approvedentries.php') {
                                            echo "menu-item-active";
                                        } ?>" aria-haspopup="true">
                    <a href="approvedentries.php" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text menu-title" > انٹریز </span>
                    </a>
                </li>

                <li class="menu-item <?php if ($_SERVER['PHP_SELF'] == '/employeeattendence.php') {
                                            echo "menu-item-active";
                                        } ?>" aria-haspopup="true">
                    <a href="employeeattendence.php" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text menu-title"> حاضری رپورٹ </span>
                    </a>
                </li>
            </ul>
